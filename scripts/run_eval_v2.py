...
Usage:
  python scripts/run_eval_v2.py                     # mock provider, tag "latest"
  python scripts/run_eval_v2.py mock v2_mock
  python scripts/run_eval_v2.py anthropic v2_real    # requires ANTHROPIC_API_KEY
"""
